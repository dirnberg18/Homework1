...
import at.fh.swengb.dirnberger.MovieListActivity.Companion.EXTRA_MOVIE_ID
...
class MovieReviewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val movieId = intent.getStringExtra("PassedId") //(MovieListActivity.EXTRA_MOVIE_ID)
        ...
        if (movieId == null) {
            ...
            movie_review_header.text = movieName
